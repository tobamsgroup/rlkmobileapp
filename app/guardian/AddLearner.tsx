    ...
    >
      ...
      >
        ...
        <ReactNativeModal isVisible={openModal}>
          <View className="bg-white p-5 rounded-[20px] items-center ju">
            <ICONS.CheckOutline
              height={scaleWidth(66)}
              width={scaleWidth(66)}
            />
            <Text className="text-center text-[20px] font-sansSemiBold ">
              Child Profile Created{'\n'}Successfully!
            </Text>
            <Text className="text-center font-sans text-[#474348] mt-3 mb-8">
              {name} is all set to begin their learning adventure. Assign a
              learning module to get started.
            </Text>
            <Button
              onPress={() => {
            ...
            <Button
              ...
              className="w-full bg-white border-[#D3D2D3] border-2 mt-4"
