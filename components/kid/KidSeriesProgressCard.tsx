  ...
  return (
    <View className="bg-white rounded-[16px] p-6 border border-[#D3D2D366] mb-5">
      ...
      <FlatList
        ...
        renderItem={({ item }) => <KidSeriesProgressCardInner />}
      />
      ...
      <Button
        onPress={() => router.push('/kid/SeriesLearningList')}
...
export const KidSeriesProgressCardInner = ({
  ...
  return (
    ...
    >
      <View className="rounded-[20px] w-full items-center relative  bg-red-300">
        {/* <View
          className={twMerge(
      ...
      <View className="flex-row items-center gap-3 mt-4">
        ...
        <Text className=" text-[#221D23] font-sansSemiBold">80%</Text>
      </View>
      <Button
